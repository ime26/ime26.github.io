...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Isabelle Eisenberg</title>
  </head>

  <body>
    <h1>Isabelle Eisenberg</h1>

    <p>Isabelle Eisenberg was born in Boca Raton Florida and is currently studying at University of Miami.</p>

    <p>Isabelle is a broadcast journalism major with a minor in Media Management is work experience in Public Relations.</p>

    <p>Isabelle is almost 21 years old and is expected to graduate University of Miami in the fall of 2024.</p>

    <p>In 2014, Isabelle left the United States for the first time in her life. Now, she has traveled to many different corners of the world. Here are some places she has gone since 2014.</p>


    <h2>Travel Experience</h2>

    <table>
      <caption>Isabelle's travels, 2015-2022</caption>
      <tr>
        <th>Year</th>
        <th>Travel</th>
      </tr>
    ...
    <p>Fantasyland is themed in a medieval-faire/carnival style, in the words of Walt Disney: "Fantasyland is dedicated to the young at heart and to those who believe that when you wish upon a star, your dreams come true."</p>

    <p>Fantasyland is comprised of:</p>
    ...
    <table>
      <caption>Magic Kingdom area resorts</caption>
      <tr>
        <th>Resort</th>
        <th>Theme</th>
        <th>Opened</th>
